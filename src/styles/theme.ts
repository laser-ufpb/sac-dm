export const theme = {
  ...
  text: "#E0E0E0", // Light Grey - Texto principal
  textSecondary: "#BDBDBD", // Grey - Texto secundário
  positive: "#4CAF50", // Green - Status positivo/sucesso
  warning: "#FFEB3B", // Yellow - Avisos e precauções
  negative: "#F44336", // Red - Erros e alertas críticos
